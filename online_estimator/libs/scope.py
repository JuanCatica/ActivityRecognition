class Scope:
    ...
    def plot_sensors(self):
        ...
        for i,label in enumerate(self.deviceManagger.get_label_serie()):
            self.canvas.create_line(i, self.height, i, self.height-25,fill=self.colors[int(label)]) 
        self.canvas.create_text(self.buff_size+50,self.height-15,fill="darkblue",font="Arial",text="Pred. Labels")
